        ...
        builder: (context, viewModel, _) {
          ...
          return Column(
            children: [
              ...
              Expanded(
                child: _isLoading
                    ? const Center(child: CircularProgressIndicator(strokeWidth: 2, color: Color(0xFF2D5AF0)))
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          const Text("MY TASK STATUS", style: TextStyle(color: Color(0xFF2D5AF0), fontSize: 8, fontWeight: FontWeight.w900, letterSpacing: 1.2)),
                          const SizedBox(height: 2),
                          Text(progress >= 1.0 ? "EVERYTHING DONE!" : "$done OF $total COMPLETED",
                              style: const TextStyle(color: Color(0xFF1A1C1E), fontSize: 18, fontWeight: FontWeight.w900)),
                        ],
                      ),
                    ),
                ...
                if (_isDashboardOpen) ...[
                  ...
                  Row(
                    children: [
                      ...
                      _buildMetricSquare("LEFT", "$remaining", Colors.blueGrey, Icons.pending_actions_rounded),
                      const SizedBox(width: 10),
                      _buildMetricSquare("OVERDUE", "$overdue", overdue > 0 ? Colors.orange : Colors.blueGrey[200]!, Icons.notification_important_rounded),
                    ],
                  ),
        ...
        children: [
          ...
          Container(
            ...
            child: TextField(
              ...
              decoration: const InputDecoration(
                ...
                prefixIcon: Icon(Icons.search_rounded, size: 20, color: Color(0xFF2D5AF0)),
          ...
          Row(
            children: [
              ...
              Expanded(
                child: _buildDropboxContainer(
                  child: DropdownButton<String>(
                    value: _selectedFilter,
                    isExpanded: true,
                    icon: const Icon(Icons.filter_alt_rounded, color: Color(0xFF2D5AF0), size: 18),
              ...
              Expanded(
                child: _buildDropboxContainer(
                  child: DropdownButton<TaskSort>(
                    value: _currentSort,
                    isExpanded: true,
                    icon: const Icon(Icons.sort_rounded, color: Color(0xFF2D5AF0), size: 18),
                    underline: const SizedBox(),
    ...
    return Row(
      children: [
        ...
        Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text(label, style: TextStyle(color: Colors.grey[400], fontSize: 7, fontWeight: FontWeight.bold, letterSpacing: 0.5)),
            Text(val, style: TextStyle(color: Colors.grey[800], fontSize: 11, fontWeight: FontWeight.w900)),
          ],
        ),
      ],
    );
  ...
  Widget _buildKeepGoingTag(double progress) {
    return Container(
      ...
      child: Text(
        ...
        style: const TextStyle(color: Color(0xFF2D5AF0), fontSize: 8, fontWeight: FontWeight.w900),
      ),
    );
  }
  ...
  AppBar _buildEliteAppBar() {
    return AppBar(
      ...
      title: const Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text("PERSONAL", style: TextStyle(color: Colors.blueGrey, fontSize: 9, fontWeight: FontWeight.w900, letterSpacing: 2)),
          Text("Tasks", style: TextStyle(color: Color(0xFF1A1C1E), fontSize: 26, fontWeight: FontWeight.w900, letterSpacing: -0.5)),
        ],
      ),
      actions: [
        IconButton(
          icon: const Icon(Icons.add_circle_outline_rounded, color: Color(0xFF2D5AF0), size: 28),
